#!/usr/bin/env python
'''
  combined multiple loh outputs and add gene annotation from transcript file
'''
...
if __name__ == '__main__':
  ...
  parser.add_argument('--min_accept', required=False, default=1, type=int, help='evidence required')
